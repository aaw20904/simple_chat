...
(function () {
  ...
  if ( true && typeof module.exports !== 'undefined') module.exports = laxInstance;else window.lax = laxInstance;
})();
...
;// CONCATENATED MODULE: ./src/images/plane.svg
var plane_namespaceObject = __webpack_require__.p + "res/plane.svg";
// EXTERNAL MODULE: ./node_modules/lax.js/lib/lax.js
var lax = __webpack_require__(178);
var lax_default = /*#__PURE__*/__webpack_require__.n(lax);
;// CONCATENATED MODULE: ./src/index.js
 


//import responsiveImage1 from "./rsp-mriya.jpg?sizes[]=360,sizes[]=640,sizes[]=1024,sizes[]=1280,sizes[]=1600,sizes[]=1920";

window.bootstrap = __webpack_require__(625)
let createTmerNOde = (parent) =>{
     if (!parent) {
    ...
    let x = parent;
    window.setInterval(()=>{
        x.innerText=`${new Date().toLocaleTimeString()}, ${navigator.onLine}`
    }, 1000);
}
...
window.onload = () => {
    ...
    lax_default().init()
    let domainAutoReplacer = new LinkReplacer();
    // Add a driver that we use to control our animations
    lax_default().addDriver('scrollY', function () {
      return window.scrollY
    })
     // Add animation bindings to elements
     lax_default().addElements('.arrow', {
        scrollY: {  
            translateY: [
              [0, clientH.scrollHeight],
              [0, -((clientH.scrollHeight * 1.2) | 0)]
            ],

            opacity: [
              [0, clientH.scrollHeight/4],
              [0.9, 0.1], 
            ], 
          }
      })

      //animation before/after elems
      let elems =  document.querySelector('.links_container');
      elems = Array.prototype.slice.call(elems.children);
      elems.forEach(v=>{
          
            let lnk = v.querySelector('.references');
